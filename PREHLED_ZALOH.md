...
| 17 | **Time Machine hostu (Mac mini Pro)** | host .24 (VM vyloučená) | **týdně na 2 cíle:** WD `My Book` (disk7s2) + Synology `VM macOS M4` (smb, síťový) | **neděle** WD 03:00 + Synology 14:00 (LaunchDaemony `tm-wd-weekly`/`tm-syno-weekly`; hodinové auto VYPNUTO) | WD **kvóta 3 TB**; NAS **kvóta 1,5 TB** (nastavit po 1. záloze), pak FIFO | nativní TM restore; rotaci WD hlídá `com.kittler.tm-wd-rotation` |
